                ...
                <div className="hidden md:block">
                  <div className="equipo2 md:flex md:mx-auto ">
                    <div className="equipo2-tarjeta">
                      <img src={avatar1} alt="Maximiliano Ferrez" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Maximiliano</h2>
                      <h2><strong>Ferrez</strong></h2>
                      <p>Back-End Developer</p>
                      <a href="https://www.linkedin.com/in/maximiliano-ferrez/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar2} alt="Leandro Brizuela" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Leandro</h2>
                      <h2><strong>Brizuela</strong></h2>
                      <p>Back-End Developer</p>
                      <a href="https://www.linkedin.com/in/leandro-brizuela-13b86a249/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={gerardobarboni} alt="Enrique Espinosa" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Enrique</h2>
                      <h2><strong>Espinosa</strong></h2>
                      <p>Back-End Developer</p>
                      <a href="https://www.linkedin.com/in/enrique-espinosa-010783251/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar1} alt="Pablo Correa" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Pablo</h2>
                      <h2><strong>Correa</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/correa-pabloc/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={ezequielmorales} alt="Carolina Gerez" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Carolina</h2>
                      <h2><strong>Gerez</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/carolina-magali-gerez/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar2} alt="Emilce Correa" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Emilce</h2>
                      <h2><strong>Correa</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/emilce-correa/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar2} alt="Diego Linares" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Diego</h2>
                      <h2><strong>Linares</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/diego-lineares-40576b215/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar2} alt="Federico Vasconcello" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Federico</h2>
                      <h2><strong>Vasconcello</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/federico-vasconcello-ab52bb20b/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>

                    <div className="equipo2-tarjeta">
                      <img src={avatar2} alt="Hugo Heredia" className="rounded-xlinline-block rounded-full equipo2-img"/>
                      <h2>Hugo</h2>
                      <h2><strong>Heredia</strong></h2>
                      <p>Front-End Developer</p>
                      <a href="https://www.linkedin.com/in/héctor-hugo-heredia-19922021/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <SwiperSlide className="h-full block md:hidden">
            ...
            <div className="flex flex-col justify-evenly">
              ...
              <div className="h-full">
                ...
                <div className="equipo2">
                  <div className="equipo2-tarjeta">
                    <img src={ezequielmorales} alt="Diego Linares" className="rounded-xlinline-block rounded-full equipo2-img"/>
                    <h2>Diego</h2>
                    <h2><strong>Linares</strong></h2>
                    <p>Front-End Developer</p>
                    <a href="https://www.linkedin.com/in/diego-lineares-40576b215/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                  ...
                  <div className="equipo2-tarjeta">
                    <img src={avatar2} alt="FederocO Vasconcello" className="rounded-xlinline-block rounded-full equipo2-img"/>
                    <h2>Federico</h2>
                    <h2><strong>Vasconcello</strong></h2>
                    <p>Front-End Developer</p>
                    <a href="https://www.linkedin.com/in/federico-vasconcello-ab52bb20b/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
                ...
                <div className="equipo2">
                  <div className="equipo2-tarjeta">
                    <img src={ezequielmorales} alt="Hugo Heredia" className="rounded-xlinline-block rounded-full equipo2-img"/>
                    <h2>Hugo</h2>
                    <h2><strong>Heredia</strong></h2>
                    <p>Front-End Developer</p>
                    <a href="https://www.linkedin.com/in/héctor-hugo-heredia-19922021/" target="_blank"  without rel="noreferrer"><div className="equipo2-icon"><img src={linkedin} alt="linkedin" /></div></a>
